...
$.ajax({
    ...
    data: {
        key: 'JXTBZ-AMN6A-ZFTKX-CHGRM-4DTY2-M3BXP',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.020687,34.74798, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
